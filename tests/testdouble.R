...
g=sqrt(psyfun(psyinv(10/15, method = "duotrio", double = TRUE),method = "duotrio",double = TRUE))

stopifnot(all.equal(f,g, tol=1e-3))

# threeAFC
f=psyfun(psyinv(10/15, method = "threeAFC", double = TRUE), method = "threeAFC")
g=sqrt(psyfun(psyinv(10/15, method = "threeAFC", double = TRUE),method = "threeAFC",double = TRUE))

stopifnot(all.equal(f,g, tol=1e-3))

# twoAFC
f=psyfun(psyinv(10/15, method = "twoAFC", double = TRUE), method = "twoAFC")
g=sqrt(psyfun(psyinv(10/15, method = "twoAFC", double = TRUE),method = "twoAFC",double = TRUE))
